...
/* Atualizado: 14/08/2023 | Adicionado informação de representante, regional e formatação DATA. */
/* Atualizado: 11/04/2023 | Alteração realizada nas condições de status, foi gerado novos status para os PNs */
